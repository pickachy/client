    ...
    public static class LoanProviderUtils
    {
        public static Dictionary<LoanProviderType, LoanProviderMeta> LoanProviderMetaMap { get; } =
            new()
            {
                ...
                {LoanProviderType.DINERO, new LoanProviderMeta{ Name = "Dinero", ImageExtension = "svg", ReferralLink = "https://cmtrckr.net/go/sg2rlv53r6"}},
                ...
                {LoanProviderType.TENGO, new LoanProviderMeta{ Name = "Tengo", ImageExtension = "svg", ReferralLink = "https://cmtrckr.net/go/srp41f4kwo"}},
                ...
                {LoanProviderType.MILOAN, new LoanProviderMeta{ Name = "Miloan", ImageExtension = "svg", ReferralLink = "https://cmtrckr.net/go/smrnw15z0q"}},
